      ...
      <section id="career" className="trustpelanggan p-2">
        <div className="container">
          ...
          <div className="row mt-3">
            <div className="col-sm-12 form-elements" data-aos="fade-right" data-aos-delay={200} data-aos-duration={800}>
            <Form className="gform pure-form pure-form-stacked" method="POST" data-email="example@email.net" action="https://script.google.com/macros/s/AKfycbxT-teyeRerT8YNyN1WLd8Ly4wrh91Jak2ufedg/exec">
              <TabContainer>
                <Row>
                  <Col sm={6}>
                  <FormGroup controlId="formBasicName">
                    ...
                    <FormGroup controlId="formBasicSubject">
                      ...
                      <Input
                        ...
                        onChange={this.handleChange.bind(this, 'university')}
                        placeholder="university"
                        required
                      />
                    </FormGroup>
                    <FormGroup controlId="formBasicMessage">
                      <Label for="file" className="text-muted">Transcripts</Label>
                      <Input
                        type="file" 
                        id="transcript" 
                        name="transcript"
                  ...
                  <Col sm={6}>
                    ...
                    <FormGroup controlId="formBasicSubject">
                      ...
                      <Input
                        ...
                        onChange={this.handleChange.bind(this, 'prodi')}
                        placeholder="program study"
                        required
                      />
                    </FormGroup>
                    <FormGroup controlId="formBasicSubject">
                      <Label for="subject" className="text-muted">Cover Letter</Label>
                      <Input
                        type="text"
                        id="subject"
                        name="subject"
